...
def main():
    ...
    if option == "Enter text":
        ...
        bmi_input = st.number_input("Enter BMI", format="%.2f", min_value=0.01, step=0.00)
        HbA1c_level_input = st.number_input("Enter HbA1c Level", format="%.2f", min_value=0.01, step=0.00)
        blood_glucose_level_input = st.number_input("Enter Blood Glucose Level", format="%.2f", min_value=0.01, step=0.00)
